...
map.getView().fit([76.080057, 11.617323, 76.235535, 11.712237], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">RESOURCE INFORMATION SYSTEM OF MEENANGADI</h2>';
        return titleElement;
    })(),
